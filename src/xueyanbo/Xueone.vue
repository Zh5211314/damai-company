  ...
  <div id="xue">
    ...
    <div class="nav">
      <ul>
        ...
        <li @click="dramatwo" class="active">亲子</li>
    ...
    <div class="splendid">
      <h2>
        <img src="../assets/img/titletwo.png" alt="图片">
      </h2>
      <div class="left"  v-for="(itemxx,index) in lists" :key="index" v-if="index == 0">
        <img :src=itemxx.image alt="图片">
      </div>
      <div class="center">
        <ul>
          <li  v-for="(itemf,index) in lists" :key="index">
            <img :src=itemf.image alt="图片">
          </li>
        </ul>
      </div>
      <div class="right"  v-for="(itemxm,inde) in lists" :key="inde" v-if="inde == 1">
        <img :src=itemxm.image alt="图片">
      </div>
    </div>
    <div class="bgs">
      <ul>
        <li>
          <img src="../assets/img/pg.png" alt="图片">
        </li>
        <li>
          <img src="../assets/img/pg.png" alt="图片">
        </li>
    ...
    <div class="field">
      <ul>
        <router-link exact to="/xueone/" tag="li"></router-link>
        <router-link to="/xueone/movie" tag="li"></router-link>
        <router-link exact to="/xueone/" tag="li"></router-link>
        <router-link to="/xueone/movie" tag="li"></router-link>
      </ul>
      <keep-alive>
    ...
    <div class="bgh">
      <h2>
        <img src="../assets/img/bg-1.png" alt="图片">
      </h2>
      <ul v-for="(itemxxl,index) in lists" :key="index" v-if="index == 0">
        <li> <img :src=itemxxl.image alt="图片"></li>
        <li> <img :src=itemxxl.image alt="图片"></li>
        <li> <img :src=itemxxl.image alt="图片"></li>
        <li> <img :src=itemxxl.image alt="图片"></li>
        <li> <img :src=itemxxl.image alt="图片"></li>
...
<style scoped lang="less">
  ...
  .field{
    ...
    ul{
      ...
      li:nth-of-type(1){
        background: url("../assets/img/全年龄段-选中.png")no-repeat center center #fff;
      }
      li:nth-of-type(2){
        background: url("../assets/img/0-3.png")no-repeat center center #fff;
      }
      li:nth-of-type(3){
        background: url("../assets/img/6-12.png")no-repeat center center #fff;
      }
      li:nth-of-type(4){
          background: url("../assets/img/3-6选中.png")no-repeat center center #fff;
      }
  ...
  .times{
    ...
    .el-picker-panel-calendar{
      ...
      width: 1196px ;
      height: 1111px;
      /deep/.el-picker-panel-calendar__body-wrapper{
        /deep/.el-picker-panel-calendar__body{
          ...
          background: url("../assets/img/未标题-7.png")no-repeat;
        }
